...
describe('MessagesDAO', () => {
  ...
  it('insert + get + listBySession 按 id 字典序', () => {
    // UUID 字典序：m-1 < m-2 < m-10 < m-a
    messages.insert(sample({ id: 'm-2', role: 'assistant', content: 'hello' }));
    messages.insert(sample({ id: 'm-1' }));
    messages.insert(sample({ id: 'm-10', role: 'assistant', content: 'ten' }));
